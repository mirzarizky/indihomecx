...
<head>
	...
	<title>Email Permintaan Survei</title>
																...
																<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
																	<tr>
																		<td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:32px; color:#252525; font-weight:normal; line-height:28px; padding:6px 0px 12px 0px;" mc:edit="welcome-title">
																			<multiline>Hai, Dyah Ayu Anindita</multiline>
																		</td>
																	</tr>
																	<tr>
																		<td align="left" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:13px; color:#4a4a4a; font-weight:normal; line-height:26px; padding-left:2px; padding-top:12px;" mc:edit="welcome-title-inner">
																			<multiline>
																				Terima Kasih telah menggunakan layanan Indihome dari Telkom Indonesia. <br /> Untuk selalu bisa memberikan pelayanan terbaik untuk para pelanggan, kami meminta kesediaan anda untuk mengisi survei kepuasan pelanggan dengan klik link
																				dibawah ini.
																				<br /><br />
																		</td>
																	</tr>
																	<tr>
																		<td height="45" align="center" valign="middle" bgcolor="#55abd6" style="-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;background:#23272b; font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#e5ae49; font-weight:bold; text-transform:uppercase;"
																		  mc:edit="newsletter-button">
																			<multiline><a href="{{config('app.url').'/s/'.$data['encryptedId']}}" style="color:#FFF; text-decoration:none;">Isi Survei</a></multiline>
																		</td>
																	</tr>
																	<tr>
																		<td align="left" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:13px; color:#4a4a4a; font-weight:normal; line-height:26px; padding-left:2px; padding-top:12px;" mc:edit="welcome-title-inner">
																			<multiline>
																				<br> Kami berharap Indihome dari Telkom Indonesia akan selalu menjadi pilihan terbaik anda.
																			</multiline>
																			...
																			<table width="250" border="0" align="left" cellpadding="0" cellspacing="0">
																				...
																				<tr>
																					<td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:20px; font-weight:normal; color:#f56333; padding-bottom:4px;" mc:edit="manager">
																						<multiline>Marketing Manager</multiline>
																					</td>
																				</tr>
																				<tr>
																					<td align="left" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:15px; color:#4a4a4a; font-weight:normal; line-height:26px; padding-bottom:20px;">
																						<multiline>STO Telkom Sukmajaya</multiline>
																					</td>
																				</tr>
																			</table>
																		</td>
