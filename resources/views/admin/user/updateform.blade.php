        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @endif
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('admin.model.update', ['model' => 'user', 'id' => $user->id])}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" class="form-control" name="nama" value="{{ $user->name }}" required>
